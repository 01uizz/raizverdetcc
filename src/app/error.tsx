...
export default function Error({
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      <div className="max-w-md w-full text-center bg-white border border-outline-variant rounded-2xl shadow-forest p-10 animate-scale-in">
        ...
        <p className="font-inter text-sm text-on-surface-variant mb-7 leading-relaxed">
